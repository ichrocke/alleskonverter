...
(function(){
  ...
  const KETTEN = {
    ...
    'vektorisieren':         ['bild-konvertieren','favicon'],
    'bildergalerie':         ['zip'],
    'favicon':               ['zip'],
  ...
  const NAMEN = {
    ...
    'bild-ascii':'Bild als ASCII-Art', 'vektorisieren':'Bild vektorisieren',
    'texterkennung':'Texterkennung', 'untertitel':'Untertitel', 'transkription':'Transkription',
