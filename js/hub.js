...
(function(){
  ...
  const REGELN = [
    ...
    { test: n => /\.(hei[cf])$/i.test(n), art: 'iPhone-Foto (HEIC)',
      tools: ['bild-konvertieren','bild-zuschneiden','hintergrund-entfernen','vektorisieren','bilder-zusammenfuegen','bild-zu-pdf','schwaerzen','bild-metadaten','texterkennung'] },
    { test: n => /\.(jpe?g|png|webp|gif|bmp|avif|tiff?)$/i.test(n), art: 'Bild',
      tools: ['bild-konvertieren','bild-zuschneiden','hintergrund-entfernen','vektorisieren','bilder-zusammenfuegen','bild-zu-pdf','schwaerzen','bild-metadaten','bildergalerie','texterkennung','favicon','qr-code','bild-ascii'] },
